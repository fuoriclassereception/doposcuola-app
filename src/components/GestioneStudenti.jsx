...
import { Plus, Phone, Mail, Edit, Trash2, CheckCircle2, AlertCircle, GraduationCap, UserCheck } from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center bg-white p-6 rounded-3xl border border-gray-200 shadow-sm">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Gestione allievi, recapiti dei genitori e stato tesseramento/GDPR</p>
        </div>
        <button
          onClick={() => onOpenModal()}
                  ...
                  {std.isMinorenne ? (
                    <div className="bg-amber-50/60 p-2.5 rounded-xl border border-amber-200/60 text-xs space-y-1">
                      ...
                      <div className="flex items-center space-x-2 text-amber-800">
                        ...
                        <span>{std.genitoreTelefono}</span>
                      </div>
                      {std.genitoreEmail && (
                        <div className="flex items-center space-x-2 text-amber-800">
